...
let handler = async(m, { conn }) => {
    ...
    if (user.reward === 0) {
        await conn.sendButtonLoc(m.chat, await(await fetch(thumbfoto)).buffer(), `Terimakasih sudah menggunakan Haruno Bot, hingga sekarang RUSH Bot sudah berjalan selama 6 bulan lebih.\nBerikut hadiah mu:
